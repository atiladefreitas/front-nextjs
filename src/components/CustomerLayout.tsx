...
function CustomerLayout({ children }: ICustomerLayout): JSX.Element {
	...
	return (
		<div className="customer-layout bg-[#eee] w-screen min-h-screen flex flex-col items-center">
			<nav className="w-full bg-[#be1e2f] flex items-center justify-center min-h-[6rem] mb-6 px-4">
			...
			<div className="w-full flex gap-2 max-w-5xl mb-6 px-4">
				<Button
			...
			<main className="w-full max-w-5xl grid grid-cols-1 gap-4 px-4">
				<CarouselDemo />
				{!isLoading && (
					<>
						<CarouselSpacing
